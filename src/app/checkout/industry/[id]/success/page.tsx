...
export default function IndustryCheckoutSuccess() {
  return (
    <main className="min-h-screen flex items-center justify-center px-4" style={{ background: '#F8F6F1' }}>
      <div className="max-w-lg w-full text-center">
        ...
        <p className="text-gray-600 leading-relaxed mb-8">
          Your 25% down payment was processed successfully. Welcome to IEBC — your custom system build
          begins immediately.
          <br /><br />
          <span className="font-semibold text-gray-800">
            Expect a kickoff call within 1–2 business days
          </span>{' '}
          to discuss your project scope, timeline, and next steps.
        </p>
        ...
        >
          <p className="font-bold text-sm mb-4" style={{ color: '#0B2140' }}>
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                timing: 'Invoiced when build begins',
                pct: '50%',
                color: '#C8902A',
                done: false,
              },
              {
                ...
                timing: 'Invoiced on system launch',
                pct: '25%',
                color: '#6b7280',
                done: false,
              },
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className={`font-semibold ${m.done ? 'text-green-700' : 'text-gray-700'}`}>
                      {m.milestone}
                    </p>
          ...
          <p className="text-xs text-gray-400 mt-4 border-t pt-3" style={{ borderColor: '#f3f4f6' }}>
            Milestone invoices are sent via email. Monthly retainer begins after your system launches.
          </p>
        </div>
        ...
        >
          ...
          {[
            { step: '1', label: 'Kickoff call scheduled', desc: 'We reach out within 24–48 hours to book your project kickoff.' },
            { step: '2', label: 'Custom build begins', desc: 'Your dedicated IEBC team builds your system to your specifications.' },
            { step: '3', label: 'System deployed & launched', desc: 'We hand off your fully automated system in 6 weeks.' },
          ].map((item) => (
            <div key={item.step} className="flex items-start gap-3">
              <div
                className="w-7 h-7 rounded-full flex items-center justify-center shrink-0 text-[#0B2140] text-xs font-bold shrink-0"
