...
const SERVICES = [
  {
    ...
    cta: { label: 'Start Formation', href: '/checkout/formation' },
    accent: '#0F4C81',
    bg: '#EEF4FF',
  },
  {
    ...
    cta: { label: 'See Website Packages', href: '/checkout/website' },
    accent: '#7C3AED',
    bg: '#F5F3FF',
  },
  {
    ...
    cta: { label: 'Get Your Hub', href: '/checkout/hub' },
    accent: '#C9A02E',
    bg: '#FFFBEB',
  },
  {
  ...
  },
  {
    ...
    cta: { label: 'Book a Strategy Call', href: 'https://calendly.com/new56money/30min' },
    accent: '#0F4C81',
    bg: '#EEF4FF',
  },
]
...
const PLANS = [
  {
    ...
    price: '$1,500',
    period: ' setup',
    desc: 'Website + Hub + Accounting Silver — everything to launch your business.',
    consultants: 1,
    users: 1,
    highlight: false,
    features: [
      '1 IEBC AI Consultant',
      '1–5 page Intelligent Website',
      'Business Hub — CRM & invoicing',
      'Accounting Silver ($9/mo after)',
      'Lead capture into your hub',
      'Client payment portal',
      '$199/mo retainer after launch',
      'Email support',
    ],
    link: '/checkout/bundle?plan=silver',
    cta: 'Get Silver Bundle',
  },
  {
    id: 'gold',
    label: 'Gold',
    price: '$2,500',
    period: ' setup',
    desc: 'Website + Hub + Accounting Gold — full system for growing teams.',
    consultants: 3,
    users: 3,
    highlight: true,
    features: [
      '3 IEBC AI Consultants',
      '6–10 page Intelligent Website',
      'Full Business Hub — all modules',
      'Accounting Gold ($22/mo after)',
      'Automated outreach & CRM',
      'Social media scheduling',
      '$349/mo retainer after launch',
      'Priority support + kickoff call',
    ],
    link: '/checkout/bundle?plan=gold',
    cta: 'Get Gold Bundle',
  },
  {
    id: 'platinum',
    ...
    price: '$4,000',
    period: ' setup',
    desc: 'Full-stack infrastructure — no limits, no compromises.',
    consultants: 5,
    users: 10,
    highlight: false,
    features: [
      '5 IEBC AI Consultants',
      'Unlimited page website + client portal',
      'Premium Hub — all modules, no limits',
      'Accounting Platinum — 22-module suite',
      'Payroll, tax center & inventory',
      'Custom automations & API integrations',
      '$549/mo retainer after launch',
      'Dedicated account manager',
    ],
    link: '/checkout/bundle?plan=platinum',
    cta: 'Get Platinum Bundle',
  },
]
