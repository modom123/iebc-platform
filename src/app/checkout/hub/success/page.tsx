...
export default function HubCheckoutSuccess() {
  return (
    <main className="min-h-screen flex items-center justify-center px-4" style={{ background: '#F8F6F1' }}>
      <div className="max-w-lg w-full text-center">
        ...
        <h1 className="text-3xl font-extrabold mb-4" style={{ color: '#0B2140' }}>Your hub build is underway!</h1>
        <p className="text-gray-600 leading-relaxed mb-8">
          Your 25% down payment was processed successfully. Your dedicated IEBC team will reach out within 1–2 business days to kick off your Automated Business Hub build.
        </p>
        ...
        <div className="rounded-2xl p-6 mb-6 text-left" style={{ background: '#fff', border: '1px solid #e5e7eb' }}>
          ...
          <div className="space-y-3">
            {[
              ...
              { milestone: 'Final Delivery', timing: 'Invoiced on launch', pct: '25%', color: '#6b7280', done: false },
            ].map((m, i) => (
          ...
          <p className="text-xs text-gray-400 mt-4 border-t pt-3" style={{ borderColor: '#f3f4f6' }}>
            Monthly $199/mo retainer begins after your hub launches.
          </p>
        </div>
        ...
        <div className="rounded-2xl p-6 mb-8 text-left space-y-4" style={{ background: '#0B2140' }}>
          ...
          {[
            ...
            { step: '2', label: 'Hub build begins', desc: 'Your IEBC team configures your CRM, automations, and workflows.' },
            { step: '3', label: 'Hub launched & handed off', desc: 'Your fully automated business hub delivered in 4–6 weeks.' },
          ].map(item => (
